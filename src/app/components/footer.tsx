            ...
            <section className="bg-[#f9f9f9] py-10">
                <div className="max-w-screen-xl mx-auto flex justify-between items-center">
                    ...
                    <div className="flex gap-6">
                        <Image src="/fb.jpg" width={16} height={16} alt="fb" className="w-6 h-6 " />
                        <Image src="/insta.jpg" width={16} height={16} alt="fb" className="w-6 h-6 " />
                        <Image src="/app/images/twitter.jpg" width={20} height={20} alt="fb" className="w-6 h-6 " />
                    </div>
                </div>
            </section>
