...
import fb from "@/app/images/fb.jpg";
import insta from "@/app/images/insta.jpg";
import twitter from "@/app/images/twitter.jpg"
              ...
              <Image src={twitter} alt="twitter" className="w-6 h-6 " />
                ...
                <section className="bg-[#FAFAFA] py-4">
                    <div className="max-w-screen-xl mx-auto flex justify-between items-center">
                        <p className="text-[#727272] text-sm font-bold">Made with love by Mustabshira Khalid. All rights reserved.</p>
