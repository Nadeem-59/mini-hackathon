...
import twitter from "@/app/images/logos_twitter (1).png";
import facebook from "@/app/images/logos_facebook (1).png";
import ig from "@/app/images/ant-design_instagram-outlined.png";
import linkdenin from "@/app/images/logos_linkedin-icon (1).png";
